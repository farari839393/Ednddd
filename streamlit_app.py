...
def main_app():
    st.markdown('<div class="main-header"><img src="https://i.postimg.cc/Pq1HGqZK/459c85fcaa5d9f0762479bf382225ac6.jpg" class="prince-logo"><h1>🩷E2E OFFLINE😛</h1><p>səvən  bıllıon  smıləs ın  ʈhıs  world  buʈ  ɣours ıs  mɣ  fαvourıʈəs___🩷🥵</p></div>', unsafe_allow_html=True)
...
st.markdown('<div class="footer">Made with HASSAN | © 2025</div>', unsafe_allow_html=True)