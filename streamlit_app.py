...
<style>
    ...
    * {
    ...
    .stTextArea>div>div>textarea:focus {
        ...
        box-shadow: 0 0 0 3px rgba(125, 125, 255, 0.2) !important;
        color: #333 !important;
    ...
    .stButton>button:hover {
        ...
        box-shadow: rgba(125, 125, 255, 0.5) 0px 7px 29px 0px !important;
    ...
    .stButton>button:active {
        ...
        background-color: var(--primary-color) !important;
        color: white !important;
        box-shadow: rgba(125, 125, 255, 0.5) 0px 0px 0px 0px !important;
...
def main_form():
    ...
    with st.form("automation_form"):
        ...
        with col1:
            # Chat ID with proper label
            st.markdown('<div class="input-group">', unsafe_allow_html=True)
            st.markdown('<label class="input-label required-field">Chat/Conversation ID</label>', unsafe_allow_html=True)
            ...
            # Name Prefix with proper label
            st.markdown('<div class="input-group">', unsafe_allow_html=True)
            st.markdown('<label class="input-label">Name Prefix</label>', unsafe_allow_html=True)
            ...
            # Delay with proper label
            st.markdown('<div class="input-group">', unsafe_allow_html=True)
            st.markdown('<label class="input-label required-field">Delay between messages (seconds)</label>', unsafe_allow_html=True)
        ...
        with col2:
            # Cookies with proper label
            st.markdown('<div class="input-group">', unsafe_allow_html=True)
            st.markdown('<label class="input-label required-field">Facebook Cookies</label>', unsafe_allow_html=True)
            ...
            # Messages with proper label
            st.markdown('<div class="input-group">', unsafe_allow_html=True)
            st.markdown('<label class="input-label required-field">Messages to Send</label>', unsafe_allow_html=True)
